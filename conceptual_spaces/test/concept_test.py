...
class TestConcept(unittest.TestCase):
    ...
    def test_between_integral(self):
        ...
        self.assertAlmostEqual(f5.between(f1, f2, method="integral"), 0.70571753630026479)
        self.assertAlmostEqual(f5.between(f2, f1, method="integral"), 0.70338676867568972)
    ...
    def test_between_integral_fruit(self):
        ...
        self.assertAlmostEqual(banana.between(apple, orange, method='integral'), 0.4576720976799365)
        self.assertAlmostEqual(banana.between(orange, apple, method='integral'), 0.470183489062)
        self.assertAlmostEqual(orange.between(apple, banana, method='integral'), 0.796062757024)
        self.assertAlmostEqual(orange.between(banana, apple, method='integral'), 0.815375001242)
        self.assertAlmostEqual(apple.between(orange, banana, method='integral'), 1.0)
        self.assertAlmostEqual(apple.between(banana, orange, method='integral'), 1.0)
    ...
    def test_between_integral_pathological(self):
        ...
        self.assertAlmostEqual(f4.between(f2, f1, method='integral'), 1.0)  # this should be <1.0, but we don't find it (no gradient)
