...
pear = cs.concept.Concept(s_pear, 1.0, 12.0, w_pear)
...
orange = cs.concept.Concept(s_orange, 1.0, 15.0, w_orange)
...
lemon = cs.concept.Concept(s_lemon, 1.0, 20.0, w_lemon)
...
granny_smith = cs.concept.Concept(s_granny_smith, 1.0, 25.0, w_granny_smith)
...
apple = cs.concept.Concept(s_apple, 1.0, 10.0, w_apple)
...
banana = cs.concept.Concept(s_banana, 1.0, 10.0, w_banana)
...
non_sweet = cs.concept.Concept(s_non_sweet, 1.0, 7.0, w_non_sweet)
...
red = cs.concept.Concept(s_red, 1.0, 20.0, w_red)
...
green = cs.concept.Concept(s_green, 1.0, 20.0, w_green)
...
blue = cs.concept.Concept(s_blue, 1.0, 20.0, w_blue)
